        ...
        <div class="selection:bg-[#FF2D20] selection:text-white">
            <div class="container mx-auto p-6">
                <div class="flex flex-wrap">
                    <div class="my-3 w-full rounded-lg bg-white pt-3 shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="mt-2 text-xl text-gray-600">
                                {{ $user->email }}
                            </h3>
                            ...
                            <p class="mt-4 text-gray-700">
                                ...
                                @if ($user->level)
                                    <a
                                        href="{{ route("level", $user->level->id) }}"
                                        class="transform text-emerald-600 transition duration-200 hover:-translate-y-1 hover:underline"
                                    >
                                        {{ $user->level->name }}
                                    </a>
                                @else
                            ...
                            <p class="text-gray-700">
                                ...
                                @forelse ($user->groups as $group)
                                    <span
                                        class="mr-2 inline-flex items-center rounded-full bg-blue-600 px-2 py-0.5 text-sm font-medium text-white"
                                    >
                                        {{ $group->name }}
                                    </span>
                                @empty
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                @foreach ($posts as $post)
                                    <div
                                        class="mb-1 flex flex-col overflow-hidden rounded bg-white text-lg font-bold shadow-lg md:flex-row"
                                    >
                                        <div class="md:w-1/3">
                                            <img
